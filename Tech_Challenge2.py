...
def main():
    ...
    with tab1:
        ...
        '''
        Ao plotar a decomposição da série temporal da Variação do Fechamento, nota-se que realmente existe uma tendência de crescimento juntamente com o múltiplas sazonalidade e anomalias residuais em 2009 e 2020.
    ...
    with tab3:
        ...
        st.plotly_chart(plot_acf_pacf(df_st),use_container_width = True)
    ...
    with tab6:
        ...
        ***Multiple Seasonal Decomposition of Time Series - MSTL*** obteve uma melhor avaliação ao validar o modelo com novos dados.
        ...
        modelo de já levar em consideração a sazonalidaede, os três passos de transformação aplicados à série temporal têm um impacto significativo em sua estrutura original.
        ...
        #     "\n No modelo ETS (Erro, Tendência, Sazonalidade) as equações state-space podem ser determinadas com base em seus componentes multiplicativos, aditivos, otimizados ou omitidos."
        ...
        '''
        Os wMAPEs de 138,17% e 87,47% indicam que o modelo não obteve sucesso na predição dos dados após a transformação matemática. 
